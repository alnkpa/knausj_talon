...
default_alphabet = "arch bat cap drum each fine gust hotel sit jury crunch look made near odd pit quench red sun trap urge vest whale plex yank zip".split(
    " "
)
